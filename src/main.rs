...
fn get_country_ranges() -> std::collections::HashMap<&'static str, Vec<(&'static str, &'static str)>> {
    ...
    ranges.insert("ID", vec![
        ("103.0.0.0/8", "103.0.0.0 - 103.255.255.255"),
        ("110.137.0.0/16", "110.137.0.0 - 110.137.255.255"),
        ("112.215.0.0/16", "112.215.0.0 - 112.215.255.255"),
        ("114.4.0.0/16", "114.4.0.0 - 114.4.255.255"),
        ("116.0.0.0/8", "116.0.0.0 - 116.255.255.255"),
        ("117.102.0.0/16", "117.102.0.0 - 117.102.255.255"),
        ("118.96.0.0/16", "118.96.0.0 - 118.96.255.255"),
        ("119.2.0.0/16", "119.2.0.0 - 119.2.255.255"),
        ("120.89.0.0/16", "120.89.0.0 - 120.89.255.255"),
        ("121.52.0.0/16", "121.52.0.0 - 121.52.255.255"),
        ("122.129.0.0/16", "122.129.0.0 - 122.129.255.255"),
        ("124.6.0.0/16", "124.6.0.0 - 124.6.255.255"),
        ("125.160.0.0/16", "125.160.0.0 - 125.160.255.255"),
        ("139.0.0.0/8", "139.0.0.0 - 139.255.255.255"),
        ("175.139.0.0/16", "175.139.0.0 - 175.139.255.255"),
        ("180.214.0.0/16", "180.214.0.0 - 180.214.255.255"),
        ("182.0.0.0/16", "182.0.0.0 - 182.0.255.255"),
        ("183.91.0.0/16", "183.91.0.0 - 183.91.255.255"),
        ("202.0.0.0/8", "202.0.0.0 - 202.255.255.255"),
        ("203.0.0.0/8", "203.0.0.0 - 203.255.255.255"),
        ("210.0.0.0/8", "210.0.0.0 - 210.255.255.255"),
        ("222.0.0.0/8", "222.0.0.0 - 222.255.255.255"),
    ]);
    ...
    ranges.insert("SG", vec![
        ...
        ("42.0.0.0/8", "42.0.0.0 - 42.255.255.255"),
        ("49.0.0.0/8", "49.0.0.0 - 49.255.255.255"),
        ("54.0.0.0/8", "54.0.0.0 - 54.255.255.255"),
        ("57.0.0.0/8", "57.0.0.0 - 57.255.255.255"),
        ("58.0.0.0/8", "58.0.0.0 - 58.255.255.255"),
        ("59.0.0.0/8", "59.0.0.0 - 59.255.255.255"),
        ("64.0.0.0/8", "64.0.0.0 - 64.255.255.255"),
        ("101.0.0.0/8", "101.0.0.0 - 101.255.255.255"),
        ("103.0.0.0/8", "103.0.0.0 - 103.255.255.255"),
        ("106.0.0.0/8", "106.0.0.0 - 106.255.255.255"),
        ("113.0.0.0/8", "113.0.0.0 - 113.255.255.255"),
        ("116.0.0.0/8", "116.0.0.0 - 116.255.255.255"),
        ("118.0.0.0/8", "118.0.0.0 - 118.255.255.255"),
        ("119.0.0.0/8", "119.0.0.0 - 119.255.255.255"),
        ("120.0.0.0/8", "120.0.0.0 - 120.255.255.255"),
        ("121.0.0.0/8", "121.0.0.0 - 121.255.255.255"),
        ("122.0.0.0/8", "122.0.0.0 - 122.255.255.255"),
        ("123.0.0.0/8", "123.0.0.0 - 123.255.255.255"),
        ("124.0.0.0/8", "124.0.0.0 - 124.255.255.255"),
        ("175.0.0.0/8", "175.0.0.0 - 175.255.255.255"),
        ("180.0.0.0/8", "180.0.0.0 - 180.255.255.255"),
        ("182.0.0.0/8", "182.0.0.0 - 182.255.255.255"),
        ("183.0.0.0/8", "183.0.0.0 - 183.255.255.255"),
        ("192.0.0.0/8", "192.0.0.0 - 192.255.255.255"),
        ("202.0.0.0/8", "202.0.0.0 - 202.255.255.255"),
        ("203.0.0.0/8", "203.0.0.0 - 203.255.255.255"),
        ("220.0.0.0/8", "220.0.0.0 - 220.255.255.255"),
        ("221.0.0.0/8", "221.0.0.0 - 221.255.255.255"),
        ("222.0.0.0/8", "222.0.0.0 - 222.255.255.255"),
    ]);
    ...
    ranges.insert("MY", vec![
        ...
        ("14.0.0.0/8", "14.0.0.0 - 14.255.255.255"),
        ("27.0.0.0/8", "27.0.0.0 - 27.255.255.255"),
        ("42.0.0.0/8", "42.0.0.0 - 42.255.255.255"),
        ("43.0.0.0/8", "43.0.0.0 - 43.255.255.255"),
        ("49.0.0.0/8", "49.0.0.0 - 49.255.255.255"),
        ("58.0.0.0/8", "58.0.0.0 - 58.255.255.255"),
        ("60.0.0.0/8", "60.0.0.0 - 60.255.255.255"),
        ("61.0.0.0/8", "61.0.0.0 - 61.255.255.255"),
        ("101.0.0.0/8", "101.0.0.0 - 101.255.255.255"),
        ("103.0.0.0/8", "103.0.0.0 - 103.255.255.255"),
        ("110.0.0.0/8", "110.0.0.0 - 110.255.255.255"),
        ("115.0.0.0/8", "115.0.0.0 - 115.255.255.255"),
        ("116.0.0.0/8", "116.0.0.0 - 116.255.255.255"),
        ("117.0.0.0/8", "117.0.0.0 - 117.255.255.255"),
        ("118.0.0.0/8", "118.0.0.0 - 118.255.255.255"),
        ("119.0.0.0/8", "119.0.0.0 - 119.255.255.255"),
        ("120.0.0.0/8", "120.0.0.0 - 120.255.255.255"),
        ("121.0.0.0/8", "121.0.0.0 - 121.255.255.255"),
